...
DECLARE
  ...
  v_role TEXT;
BEGIN
  -- Check if user already has an organization using INTO variables
  ...
  INSERT INTO organization_members (user_id, role, organization_id)
  VALUES (p_user_id, 'admin', v_org_id);
